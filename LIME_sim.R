...
### ----- sens runs ----------- ###
	...
	### ----- generate data -----------###
	## copy data files from similar previous directory
	init_dir <- base_dir_vec[grepl("/LC10/",base_dir_vec) & grepl("ESS_20",base_dir_vec)==FALSE]
	init_modcombos <- base_modcombos[which(base_modcombos$Data_avail=="LC10" & base_modcombos$ESS!="ESS_20"),]
...
### ----- sens runs ----------- ###
	...
	start_gen <- Sys.time()
	foreach(loop=1:length(dome_low_dirs), .packages=c('TMB','LIME')) %dopar% generate_data(modpath=dome_low_dirs[loop], data_avail=as.character(dome_low_modcombos[loop,"Data_avail"]), itervec=itervec, Fdynamics=as.character(strsplit(dome_low_modcombos[loop,"Fdyn"],"_")[[1]][2]), Rdynamics=as.character(strsplit(dome_low_modcombos[loop,"Rdyn"],"_")[[1]][2]), write=TRUE, lh=lh_dome_low[[as.character(strsplit(dome_low_modcombos[loop,"LH"],"_")[[1]][2])]], Nyears=20, comp_sample=as.numeric(strsplit(dome_low_modcombos[loop,"ESS"],"_")[[1]][2]), rewrite=FALSE, init_depl=c(0.05,0.95))
	end_gen <- Sys.time() - start_gen

	start_gen <- Sys.time()
	foreach(loop=1:length(dome_high_dirs), .packages=c('TMB','LIME')) %dopar% generate_data(modpath=dome_high_dirs[loop], data_avail=as.character(dome_high_modcombos[loop,"Data_avail"]), itervec=itervec, Fdynamics=as.character(strsplit(dome_high_modcombos[loop,"Fdyn"],"_")[[1]][2]), Rdynamics=as.character(strsplit(dome_high_modcombos[loop,"Rdyn"],"_")[[1]][2]), write=TRUE, lh=lh_dome_high[[as.character(strsplit(dome_high_modcombos[loop,"LH"],"_")[[1]][2])]], Nyears=20, comp_sample=as.numeric(strsplit(dome_high_modcombos[loop,"ESS"],"_")[[1]][2]), rewrite=FALSE, init_depl=c(0.05,0.95))
	end_gen <- Sys.time() - start_gen
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\low\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\high\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
...
## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\low\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\high\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\low\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\high\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\low\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\high\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-10,4), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\low\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\high\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-10,4), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\low\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\high\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-10,4), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\low\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\high\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\low\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\high\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\low\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\high\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\low\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\high\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\low\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\high\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\low\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\high\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\low\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\high\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\low\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\high\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\low\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\high\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\low\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\high\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\low\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\high\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\low\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\M\\high\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\low\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\high\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\low\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\high\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\low\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\linf\\high\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\low\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\high\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\low\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\high\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\low\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\vbk\\high\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\low\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\high\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\low\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\high\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\low\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\ML50\\high\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
########## Base
## short
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\low\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\high\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(2, cex.axis=2, las=2)
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## medium
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\low\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\high\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)

## long
path1 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\low\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path2 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
path3 <- "F:\\Merrill\\Git_Projects\\LIME_sim\\sens_base\\CVlen\\high\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR"
plot_re2(dirs=c(path1,path2,path3), ylim=c(-2.5,2.5), itervec=itervec, yaxt="n", xaxt="n")
axis(1, at=1:3, labels=c("-25%", "true", "+25%"), cex.axis=2)
mtext("Variability", cex=2, side=4, line=1)
mtext("Estimation error", outer=TRUE, side=2, line=3, cex=1.5)
...
## base
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LBSPR10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR")

res <- plot_output(LIME_dir=LIME_dir, LBSPR_dir=LBSPR_dir, sim=TRUE, iter=iter)

## base - lower sigmaR
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LC10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LBSPR10\\ESS_1000\\LH_Medium\\F_Ramp\\R_AR")
...
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LBSPR10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR")

res <- plot_output(LIME_dir=LIME_dir, LBSPR_dir=LBSPR_dir, sim=TRUE, iter=15)

## base - lower sigmaR
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LC10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LBSPR10\\ESS_1000\\LH_Short\\F_Ramp\\R_AR")
...
## base
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LBSPR10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR")

res <- plot_output(LIME_dir=LIME_dir, LBSPR_dir=LBSPR_dir, sim=TRUE, iter=iter)

## base - lower sigmaR
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LC10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LBSPR10\\ESS_1000\\LH_Long\\F_Ramp\\R_AR")
...
## base
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LBSPR10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR")

res <- plot_output(LIME_dir=LIME_dir, LBSPR_dir=LBSPR_dir, sim=TRUE, iter=iter)

## base - lower sigmaR
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LC10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LBSPR10\\ESS_100\\LH_Medium\\F_Ramp\\R_AR")
...
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LBSPR10\\ESS_100\\LH_Short\\F_Ramp\\R_AR")

res <- plot_output(LIME_dir=LIME_dir, LBSPR_dir=LBSPR_dir, sim=TRUE, iter=iter)

## base - lower sigmaR
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LC10\\ESS_100\\LH_Short\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LBSPR10\\ESS_100\\LH_Short\\F_Ramp\\R_AR")
...
## base
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base\\LBSPR10\\ESS_100\\LH_Long\\F_Ramp\\R_AR")

res <- plot_output(LIME_dir=LIME_dir, LBSPR_dir=LBSPR_dir, sim=TRUE, iter=iter)

## base - lower sigmaR
LIME_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LC10\\ESS_100\\LH_Long\\F_Ramp\\R_AR")
LBSPR_dir <- file.path("F:\\Merrill\\Git_Projects\\LIME_sim\\base_lowsigR\\LBSPR10\\ESS_100\\LH_Long\\F_Ramp\\R_AR")
